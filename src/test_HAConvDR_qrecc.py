...
from data import padding_seq_to_same_length, Retrieval_qrecc
import os
from os import path
...
def get_test_query_embedding(args):
    ...
    test_dataset = Retrieval_qrecc(args, tokenizer, args.test_file_path)
...
def get_args():
    ...
    parser.add_argument("--test_file_path", type=str, default="../datasets/qrecc/test_with_gold_rel.json")
    parser.add_argument("--passage_embeddings_dir_path", type=str)
    parser.add_argument("--passage_offset2pid_path", type=str)
    parser.add_argument("--pretrained_encoder_path", type=str, default="../output/qrecc/model/best_model")
    parser.add_argument("--qrel_output_path", type=str, default="../output/qrecc")
    parser.add_argument("--output_trec_file", type=str)
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="datasets/qrecc/new_preprocessed/qrecc_qrel.tsv")
